...
public class StepInterceptor2 {
    ...
    public StepInterceptor2(WorkflowMetadata<?> metadata, WorkflowSessionBase<?> session) {
    ...
    @RuntimeType
    public Object delegate(@This WorkflowSessionBase<?> session,
                           @DefaultCall Callable<?> superCall,
                           @Origin Method method,
                           @AllArguments Object... args) throws Throwable {
        return invoke(superCall, method, args);
    }
